...
getContractFactory(name: 'PollingSystem', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.PollingSystem__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'PollingSystem', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.PollingSystem>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'PollingSystem', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.PollingSystem>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'PollingSystem', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.PollingSystem>
